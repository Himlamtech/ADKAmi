...
class RAG_Agent_admission(BaseAgent):
    ...
    async def _run_async_impl(self, ctx : InvocationContext) -> AsyncGenerator[Event, None]:
        ...
        # retrieve
        retrieved_docs = find_similar_information_by_hybrid_search(query = query, limit = self.top_k, candidates = self.candidates, vector_search_index = self.vector_search_index, atlas_search_index = self.atlas_search_index)
